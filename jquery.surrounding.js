	...
	$.fn.surround = function(option) {
		...
		$(this).on("dblclick",function(){
			if(! that.hasClass("fullscreen")) {
				that.clone().appendTo("body").addClass("fullscreen").css({"position":"fixed","top":0,"left":0,"margin":0}).animate({"width":"100%","height":"100%"},500,function(){jQuery(this).surround(option);});
			}else{
